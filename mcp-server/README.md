# technocore-watch-mcp

An MCP server that wraps [Technocore Watch](https://technocore-watch-one.vercel.app)'s
...
By default the server reads `https://technocore-watch-one.vercel.app`. To point it at a
